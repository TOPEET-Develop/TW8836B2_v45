...
BYTE ActionRemoHDMI(BYTE _RemoDataCode, BYTE AutoKey)
{
	...
	value = ReadI2C_multi(0x78, 0x21, 0x0900);
	if ((value & 0x03) != 0x03)
	{
	...
	case REMO_SELECT:	//0x00;Select
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x00);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_CHNUP: //0x01:Up
  		dPuts("\n\rREMO1_CHNUP pressed!!!");
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x01);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_CHNDN: //0x02:Down
  		dPuts("\n\rREMO1_CHNDN pressed!!!");
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x02);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_VOLDN: //0x03:Left
  		dPuts("\n\rREMO1_VOLDN pressed!!!");
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x03);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_VOLUP: //0x04:Right
  		dPuts("\n\rREMO1_VOLUP pressed!!!");
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x04);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
 	//0x05:Right-Up
	...
	case REMO_EXIT:	//0x09:Root Menu
  		dPuts("\n\rREMO_EXIT pressed!!!");
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x09);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	//0x0A Setup Menu
	...
	//0x0D: Exit
	case REMO_NUM0:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x20);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM1:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x21);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM2:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x22);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM3:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x23);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM4:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x24);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM5:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x25);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM6:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x26);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM7:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x27);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM8:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x28);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_NUM9:
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x29);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	//0x2A Dot
	...
	case REMO_INPUT: // 0x34 Input Select
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x34);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_INFO:	   //0x35 Show Information
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x35);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	//0x36 Help
	...
	case REMO_MUTE: //0x43 Mute
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x43);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	//0x44 Play
	...
	case REMO_TTXCYAN: 	//0x71 F1 (Blue)
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x71);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_TTXRED:	//0x72 F2 (Red)
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x72);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_TTXGREEN:	 //0x73 F3 (Green)
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x73);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	case REMO_TTXYELLOW: //0x74 F4 (Yellow)
		WriteI2C_multi(0x78, 0x21, 0xA01, 0x74);
		WriteI2C_multi(0x78, 0x21, 0xA00, 0x10);
		ret = EAT_KEY;
		break;
	//0x75 F5
	...
	case REMO_PIPON:
		...
		dPuts("\n\rCEC_AUTO OFF");
		//WriteI2C_multi(0x78,0x21, 0x800, 0x00);
		global_CEC_flag = 0;
...
//#endif
	...
	case REMO_PIPON:
		...
		if (InputMain == INPUT_HDMIPC || InputMain == INPUT_HDMITV)
		{
			dPuts("\n\rCEC_AUTO ON");
			//BK130402
			//WriteI2C_multi(0x78,0x21, 0x800, 0x01);
			global_CEC_flag = 1;
		}
#endif
		break;
