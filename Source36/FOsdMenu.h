...
#define FMID_BT656_SRC_SELECTION		0x2e
										//BK130425 0x30->0x40. 0x30 was used on FMID_PC_COLOR_TEMP
#define FMID_BT656_FROM_DEC				(0x40| BT656ENC_SRC_DEC)
#define FMID_BT656_FROM_PC				(0x40| BT656ENC_SRC_ARGB)
#define FMID_BT656_FROM_HDMI			(0x40| BT656ENC_SRC_DTV)
#define FMID_BT656_FROM_LVDS			(0x40| BT656ENC_SRC_LVDS)
#define FMID_BT656_FROM_PANEL			(0x40| BT656ENC_SRC_PANEL)
#define FMID_BT656_FROM_OFF				(0x40| BT656ENC_SRC_OFF)
#define FMID_BT656_FROM_AUTO			(0x40| BT656ENC_SRC_AUTO)
