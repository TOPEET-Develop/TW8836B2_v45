...
code struct menu_fitem_info_s menu_sys_info_text_items[] = {			//BK110811
	{ 0,0,	X_START+306-220,Y_START+313-260,	10,1, 0,0,	0x1F,	 16,0x07E0	}, 	//EVB
	{ 1,10,	X_START+420-220,Y_START+344-260,	10,1, 0,0,	0x1F,	 16,0x07E0	} 	//FW REV
};
...
#if 0
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+242-220, Y_START+320-260,ALIGN_TOPLEFT,	&img_slide_gray,NULL,			0,SOSD_WIN3,0x080,  2,0,2,0},	//start x,y. Gray 
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+449-220, Y_START+320-260,ALIGN_TOPLEFT,	&img_slide_red,NULL,			0,SOSD_WIN8,0x100,  2,0,2,0},	//end x,y.   Red
#else
...
#else
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+242-220,Y_START+228-169,ALIGN_TOPMIDDLE,&img_slide_gray,NULL,					0,SOSD_WIN3,0x080,  0,0,0,0},	//  start x,y  //slider R
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+488-220,Y_START+268-169,ALIGN_TOPMIDDLE,&img_slide_red,NULL,					0,SOSD_WIN8,0x100,  2,0,7,0},	//5 end x,y
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+242-220,Y_START+273-169,ALIGN_TOPMIDDLE,&img_slide_gray,NULL,					0,SOSD_WIN4,0x080,  0,0,0,0},	// start x,y  //slider G
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+488-220,Y_START+313-169,ALIGN_TOPMIDDLE,&img_slide_red,NULL,					0,SOSD_WIN8,0x100,  5,0,9,0},	//7 end x,y
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+242-220,Y_START+320-169,ALIGN_TOPMIDDLE,&img_slide_gray,NULL,					0,SOSD_WIN5,0x080,  0,0,0,0},	// start x,y   //slider B
{ TYPE_SLIDE, proc_slider_ctrl,	X_START+488-220,Y_START+360-169,ALIGN_TOPMIDDLE,&img_slide_red,NULL,					0,SOSD_WIN8,0x100,  7,0,2,0},	//9 end x,y
#endif
...
code struct menu_fitem_info_s menu_slider3_text_items[] = {
	//just test
	{ 0,0,	X_START+520-220,Y_START+235-169,	3,1, 0,0,	0xF0,	 0x08,	FOSD_COLOR_VALUE_RED	},	//R, or F81F:Magenta
	{ 1,3,	X_START+520-220,Y_START+278-169,	3,1, 0,0,	0xF0,	 0x18,	FOSD_COLOR_VALUE_LIME	},	//G
	{ 2,6,	X_START+520-220,Y_START+324-169,	3,1, 0,0,	0xF0,	 0x10,	FOSD_COLOR_VALUE_BLUE	},	//B, or 07FF:Cyan 
};
...
//	{ 1,3,	518-220,226-179,	3,1, 0,0,	0xF0,	 0x18,	0x07E0	},	//V
	{ 0,0,	X_START+518-220,Y_START+198-179,	3,1, 0,0,	0xA0,	 0x10,	0x07E0	},	//H
	{ 1,3,	X_START+518-220,Y_START+226-179,	3,1, 0,0,	0xA0,	 0x18,	0x07E0	},	//V
};  
