...
#define PC_COLOR_DATA	0x80	// StartAddress of EEPROM for PC Color Temperature		BUGBUG Please link it with EEPROM.h
...
{
	//Printf("\n\rFOsdHighMenu cursor_item:%bx  MenuChild[cursor_item].Id:%bx",cursor_item, MenuChild[cursor_item].Id);
