...
code image_item_info_t img_navi_close  					= {1, MENU_B_FLASH_START+0x009E20, NULL,	0xff};    // img_navi_close 
...
code image_item_info_t img_navi_setup  					= {1, MENU_B_FLASH_START+0x00CA60, NULL,	0xff};    // img_navi_setup 
...
code image_item_info_t img_main_input  					= {1, MENU_B_FLASH_START+0x0236C0, NULL,	0xff};    // img_main_input 
code image_item_info_t img_main_input1  				= {1, MENU_B_FLASH_START+0x026D90, NULL,	0xff};    // img_main_input1 
code image_item_info_t img_main_audio  					= {1, MENU_B_FLASH_START+0x02A460, NULL,	0xff};    // img_main_audio 
code image_item_info_t img_main_audio1  				= {1, MENU_B_FLASH_START+0x02D7B0, NULL,	0xff};    // img_main_audio1 
code image_item_info_t img_main_system  				= {1, MENU_B_FLASH_START+0x030B00, NULL,	0xff};    // img_main_system 
...
code image_item_info_t img_input_bg_bottom  			= {1, MENU_B_FLASH_START+0x04F1C0, NULL,	0x5B};    // img_input_bg_bottom 
code image_item_info_t img_input_bg_top  				= {1, MENU_B_FLASH_START+0x050E70, NULL,	0x5B};    // img_input_bg_top 
code image_item_info_t img_input_nodvi_bg_top  			= {1, MENU_B_FLASH_START+0x05F060, NULL,	0x5B};    // img_input_nodvi_bg_top 
code image_item_info_t img_input_select  				= {1, MENU_B_FLASH_START+0x06CF30, NULL,	0x5B};    // img_input_select 
code image_item_info_t img_input_cvbs 		 			= {1, MENU_B_FLASH_START+0x06D3A0, NULL,	0xff};    // img_input_cvbs 
code image_item_info_t img_input_cvbs1 		 			= {1, MENU_B_FLASH_START+0x06E730, NULL,	0xff};    // img_input_cvbs1 
code image_item_info_t img_input_svideo  				= {1, MENU_B_FLASH_START+0x06FB00, NULL,	0xff};    // img_input_svideo 
code image_item_info_t img_input_svideo1  				= {1, MENU_B_FLASH_START+0x071240, NULL,	0xff};    // img_input_svideo1 
code image_item_info_t img_input_ypbpr  				= {1, MENU_B_FLASH_START+0x072980, NULL,	0xff};    // img_input_Ypbpr 
code image_item_info_t img_input_ypbpr1  				= {1, MENU_B_FLASH_START+0x073FA0, NULL,	0xff};    // img_input_Ypbpr1 
code image_item_info_t img_input_pc  					= {1, MENU_B_FLASH_START+0x075580, NULL,	0xff};    // img_input_pc 
...
code image_item_info_t img_input_hdmi  					= {1, MENU_B_FLASH_START+0x07A970, NULL,	0xff};    // img_input_hdmi 
code image_item_info_t img_input_hdmi1  				= {1, MENU_B_FLASH_START+0x07BF40, NULL,	0xff};    // img_input_hdmi1 
code image_item_info_t img_input_ext  					= {1, MENU_B_FLASH_START+0x07D490, NULL,	0xff};    // img_input_ext 
code image_item_info_t img_input_ext1  					= {1, MENU_B_FLASH_START+0x07E730, NULL,	0xFF};    // img_input_ext1 
code image_item_info_t img_input_return  				= {1, MENU_B_FLASH_START+0x07F9D0, NULL,	0xff};    // img_input_return 
...
code image_item_info_t img_wait  						= {1, MENU_B_FLASH_START+0x3021D0, NULL,	0x00};    // img_wait. 48x50x10 
...
code MonOsdData_t MonSOsdImgTable[] = {
	...
	//===================================
	{ &img_slide_bg, 		"slide_bg "},
	{ &img_slide3_bg, 		"slide3_bg"},
	{ &img_input_hdmi, 		"hdmi     "},
	{ &img_dvi_mode_24bit, 	"dvi24    "},
	//===================================
...
BYTE MonOsdLutLoad(BYTE img_n, BYTE sosd_win, WORD lut)
{
	...
	ePrintf("\nMonOsdLutLoad(%bd,%bd,%d)",img_n,sosd_win, lut);
