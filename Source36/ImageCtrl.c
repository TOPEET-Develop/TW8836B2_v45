...
static WORD PcBaseClock;	
static BYTE PcBasePhase;
static WORD PcBasePosH;
static BYTE PcBasePosV;
...
BYTE GetaRGB_Clock(void)
{
	BYTE bTemp;
	WORD wTemp;
	struct DIGIT_VIDEO_TIME_TABLE_s *pVesaTimeTable;
	...
	PcBaseClock = pVesaTimeTable->hTotal-1;
